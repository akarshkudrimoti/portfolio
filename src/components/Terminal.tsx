  ...
  const projects: Project[] = [
    {
      ...
      imageUrl: process.env.NODE_ENV === 'production' ? '/Portfolio/images/fraction-dash.jpg' : '/images/fraction-dash.jpg'
    },
    {
      id: 2,
      name: "Snake AI",
      ...
      imageUrl: process.env.NODE_ENV === 'production' ? '/Portfolio/images/snake-ai.jpg' : '/images/snake-ai.jpg'
    },
    {
      id: 3,
      ...
      imageUrl: process.env.NODE_ENV === 'production' ? '/Portfolio/images/storm-robotics.jpg' : '/images/storm-robotics.jpg'
    }
  ];
